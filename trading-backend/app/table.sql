...
CREATE TABLE IF NOT EXISTS Portfolio (
    ...
    INDEX (user_id),
    INDEX (entry_date),
    UNIQUE KEY uq_portfolio_user_date (user_id, entry_date)
);
...
CREATE TABLE IF NOT EXISTS Transactions (
    ...
    timing ENUM('pre_open', 'after_close') NOT NULL DEFAULT 'after_close',
    FOREIGN KEY (user_id) REFERENCES Users(id) ON DELETE CASCADE,
    INDEX (user_id),
...
CREATE TABLE IF NOT EXISTS Financial (
    ...
    ffa DECIMAL(12, 2) DEFAULT 0,
    play DECIMAL(12, 2) DEFAULT 0,
    ltss DECIMAL(12, 2) DEFAULT 0,
    give DECIMAL(12, 2) DEFAULT 0,
    expenses DECIMAL(12, 2) DEFAULT 0,
    gains DECIMAL(12, 2) DEFAULT 0,
    networth DECIMAL(12, 2) DEFAULT 0,
    comments TEXT DEFAULT NULL,
    FOREIGN KEY (user_id) REFERENCES Users(id) ON DELETE CASCADE,
    UNIQUE KEY uq_financial_user_date (user_id, entry_date),
    INDEX (user_id),
    INDEX (entry_date)
);
